...
macro (qt5_post_build_windeployqt APP QMLDIR)
    ...
    add_custom_command(TARGET ${APP} POST_BUILD
            COMMAND "echo" "blah blah $<$<CONFIG:Debug>:${QTBIN}> $<$<NOT:$<CONFIG:Debug>>:Yooooo>")
...
macro (qt5_post_build_macdeployqt APP QMLDIR)
    ...
    add_custom_command(TARGET ${APP} POST_BUILD
            COMMAND ${QTBIN}/macdeployqt.exe -qmldir ${QMLDIR} $<TARGET_FILE:${APP}> WORKING_DIRECTORY ${CMAKE_SOURCE_DIR})
